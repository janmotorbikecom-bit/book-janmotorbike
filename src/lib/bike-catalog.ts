...
export const DEFAULT_PRICING_TIERS: Record<number, number[]> = {
  ...
  3500000: [0, 350000, 590000, 760000, 930000, 1120000, 1220000, 1380000, 1500000, 1620000, 1760000, 1900000, 2040000, 2180000, 2300000, 2420000, 2540000, 2660000, 2780000, 2900000, 3000000, 3120000, 3250000, 3400000, 3500000, 3500000],
